...
export const metadata = {
  title: 'Venue Management | DAFT Arena Admin',
  description: 'Manage arenas, courts, and physical facilities.',
};
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-10 max-w-6xl">
      ...
      <WidgetContainer className="p-12 text-center flex flex-col items-center justify-center border-dashed bg-card/10">
        <div className="w-16 h-16 rounded-full bg-violet-500/10 flex items-center justify-center mb-4">
          <MapPin className="w-8 h-8 text-violet-400 opacity-80" />
        </div>
        <h3 className="text-sm font-bold text-foreground mb-1">Venue Management Operational Area</h3>
