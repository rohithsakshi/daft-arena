...
export const metadata = {
  title: 'Administrator Dashboard | DAFT Arena Admin',
  description: 'Central command center for DAFT Arena operations.',
};

export default function AdminAdministratorDashboardPage() {
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10 max-w-6xl">
      ...
      <WidgetContainer className="p-12 text-center flex flex-col items-center justify-center border-dashed bg-card/10">
        ...
        <h3 className="text-sm font-bold text-foreground mb-1">Administrator Dashboard Operational Area</h3>
