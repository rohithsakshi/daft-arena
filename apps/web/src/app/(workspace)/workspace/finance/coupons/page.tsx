...
export const metadata = {
  title: 'Coupons & Discounts | DAFT Arena Finance',
  description: 'Create and manage percentage or fixed discount rules.',
};

export default async function FinanceCouponsDiscountsPage() {
  const data = await FinanceService.getMockData('coupons');
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-10 max-w-6xl">
      ...
      <WidgetContainer className="p-12 text-center flex flex-col items-center justify-center border-dashed bg-card/10">
        ...
        <h3 className="text-sm font-bold text-foreground mb-1">Coupons & Discounts Module</h3>
