    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back to DAFT Arena. Here's an overview of your platform.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">3 ongoing tournaments</p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card className="col-span-4">
          ...
          <CardContent>
            <div className="h-[200px] flex items-center justify-center text-muted-foreground text-sm border rounded-md border-dashed">
              [Tournaments Data Table Placeholder]
            </div>
          </CardContent>
        </Card>
