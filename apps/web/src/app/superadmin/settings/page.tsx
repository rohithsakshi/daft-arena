...
import { Settings, Globe, Mail, ShieldAlert, Save, Shield } from 'lucide-react';
import { PlatformSettingsService } from '@/modules/settings/services/PlatformSettingsService';
import { RoleToggles } from '@/app/(workspace)/workspace/tournament-admin/settings/roles/RoleToggles';
...
export default async function PlatformSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Role Feature Flags — Superadmin Only */}
      <div className="bg-card border border-border rounded-2xl p-6">
        <div className="mb-4">
        ...
        <h3 className="text-xl font-bold text-white mb-2">Role Feature Flags</h3>
